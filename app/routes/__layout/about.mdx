...
This website is my playground, as it is for any developer, I guess. By now, it has been a [Vuepress](https://vuepress.vuejs.org/) page, a [Sapper](https://sapper.svelte.dev/) page, a [NuxtJS](https://nuxtjs.org/) with the [nuxt/content](https://content.nuxtjs.org/) plugin and [Windi CSS](https://windicss.org/). I've also been using [iles](https://iles-docs.netlify.app/), lately and I really liked it. Now I've switched over to using [Remix](https://remix.run) because I absolutely fell in love with the framework and its fresh approach. Check out the [repo](http://github.com/herrBertling/herrsiering.de/). And tell me what I could do better [in the repo issues](http://github.com/herrBertling/herrsiering.de/issues/new)!

<Buzzwords words={["Vue", "Svelte", "React", "Remix", "Tailwind"]} />
...
Wait… hadn't I just started freelancing? Oh, yes, I had. And as soon as I did, some interesting interview opportunities came up. I could have joined BigTech™ – and I was offered a job at [zolar](https://www.zolar.de). Which to be honest was a no-brainer. Putting everything I learned in web development into the most important topic for all of us (hint: climate change, not ice cream) is what I want to do. So now I'm here, working with a React frontend to help put more solar panels on roofs. And I'm loving it.
...
From June 2022 on, I'm working as a freelance software engineer. More on that on the [freelance](/freelance) page.

## Stealth Startup, working on a cloud PaaS

### 04/2022 - 05/2022

With a group of former Jimdo colleagues, I’ve prototyped the frontend for a product in the cloud PaaS space. I used React with Remix.run and TailwindCSS to quickly build up and iterate on the interface and APIs.

Writing Lambda functions in TypeScript and wiring everything up via the AWS CDK was also part of the job.
...
Based on various reasons, I made the decision to open myself up to other opportunities. See more on [this page](/next).

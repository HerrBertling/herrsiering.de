...
This website is my playground, as it is for any developer, I guess. By now, it
has been a [Vuepress](https://vuepress.vuejs.org/) page, a
[Sapper](https://sapper.svelte.dev/) page, a [NuxtJS](https://nuxtjs.org/) with
the [nuxt/content](https://content.nuxtjs.org/) plugin and
[Windi CSS](https://windicss.org/). I've also been using
[iles](https://iles-docs.netlify.app/), lately and I really liked it. Now I've
switched over to using [Remix](https://remix.run) because I absolutely fell in
love with the framework and its fresh approach. Check out the
[repo](http://github.com/herrBertling/herrsiering.de/). And tell me what I could
do better
[in the repo issues](http://github.com/herrBertling/herrsiering.de/issues/new)!

<Buzzwords words={["Vue", "Svelte", "React", "Remix", "Tailwind"]} />

Besides that, I'm spending most of my free time to play with my daughter rather

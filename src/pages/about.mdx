...
I built this website about two years ago. By now, it has been a [Vuepress](https://vuepress.vuejs.org/) page, a [Sapper](https://sapper.svelte.dev/) page, a [NuxtJS](https://nuxtjs.org/) with the [nuxt/content](https://content.nuxtjs.org/) plugin and [Windi CSS](https://windicss.org/). Now I'm using [iles](https://iles-docs.netlify.app/), I really like it. Check out the [repo](http://github.com/herrBertling/herrsiering.de/). And tell me what I could do better [in the repo issues](http://github.com/herrBertling/herrsiering.de/issues/new)!
...
Based on various reasons, I made the decision to open myself up to other opportunities. I've already decided what to do, more on this later on.
